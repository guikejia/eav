 ...
 * @property null|AttributeGroup[] $groups
 * @property null|AttributeSet[] $attributeSets
...
class Attribute extends Model
{
    ...
    public function getAttributeGroupModel(): \Hyperf\Database\Model\Relations\BelongsToMany
    {
        return $this->belongsToMany(AttributeGroup::class, 'entity_attribute', 'attribute_id', 'group_id');
    }

    public function getAttributeSetModel(): \Hyperf\Database\Model\Relations\BelongsToMany
    {
